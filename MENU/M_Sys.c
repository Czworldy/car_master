	...
	while (1)
	{
		...
		switch (ccd_plot_idx)
		{
			...
			case 1:
				...
				POINT_COLOR=LGRAY;
				for (i = 0; i <= 13; ++i)
					LCD_DrawLine(18+20*i, 6+36*4+6, 18+20*i, 6+36*4+255+6);				//»­Ïß
				LCD_DrawLine(18, 6+36*4+6, 18+20*13, 6+36*4+6);				//»­Ïß
				for (i = 1; i <= 5; ++i)
					LCD_DrawLine(18, 6+36*4+6+5+50*i, 18+20*13, 6+36*4+6+5+50*i);				//»­Ïß
				POINT_COLOR=BLACK;
